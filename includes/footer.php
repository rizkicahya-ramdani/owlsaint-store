    ...
    <footer class="bg-darker py-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">OwlSaint</h3>
                    <p class="text-gray-400">Premium game accounts marketplace with guaranteed security and customer satisfaction.</p>
                </div>
                <div>
                    <h4 class="text-lg font-semibold mb-4">Quick Links</h4>
                    <ul class="space-y-2">
                        <li><a href="../index.php" class="text-gray-400 hover:text-primary transition">Home</a></li>
                        <li><a href="../pages/products.php" class="text-gray-400 hover:text-primary transition">Products</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-center space-x-2 text-gray-400">
                            ...
                            <span>support@owlsaint.com</span>
                        </li>
                        <li class="flex items-center space-x-2 text-gray-400">
